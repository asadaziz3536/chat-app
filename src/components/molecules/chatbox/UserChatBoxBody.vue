  ...
  data() {
    return {
      ...
      chatMessages: [
        {
          sender: "Bot",
          avatarSource: "/src/assets/images/Bot.png",
          time: "9:30 AM",
          message: "John contacted you with Sophie Okonedo",
        },
        {
...
<template>
  <div class="user-chatbox-body flex-grow-1 overflow-auto custom-scrollbar">
    ...
    <!-- <div class="chat-message-wrapper">
      <div class="d-flex gap-2">
        <AvatarImg
          width="36"
          height="36"
          :source="'/src/assets/images/Bot.png'"
        />
        <div class="chat-message-content">
          <div class="chat-message-meta">
            ...
            />
            &nbsp;
            <Text class="fs-12" content="9:30 AM"></Text>
          </div>
    ...
    <div class="chat-message-wrapper response">
      <div class="d-flex gap-2 justify-content-right flex-row-reverse">
        <AvatarImg
          width="36"
          height="36"
          :source="'/src/assets/images/me.png'"
        />

        <div class="chat-message-content">
          <div class="chat-message-meta">
            <Text class="fw-bolder clr-lighter fs-14" content="You" />
            &nbsp;
            <Text class="fs-12" content="9:30 AM"></Text>
          </div>
          <div class="d-flex align-items-center">
            <div class="chat-message response-msg">
              <Paragraph
                class="fs-16 mb-0 text-white"
                content="Hey Ali! Yes, I got tickets. Super excited! 🎶"
              />
            </div>
          </div>
        </div>
    ...
    <div class="chat-message-wrapper response">
      <div class="d-flex gap-2 justify-content-right flex-row-reverse">
        ...
        <div class="chat-message-content">
          ...
          <div class="file-thumbnail pb-1">
            <img :src="'/src/assets/images/thumbnail.png'" alt="" />
          </div>
          <div class="d-flex align-items-center">
            <div class="chat-message response-msg">
              <Paragraph
                class="fs-16 mb-0 text-white"
                content="Hey Sophie! Yes, I got tickets. Super excited! 🎶"
              />
            </div>
          </div>
        </div>
